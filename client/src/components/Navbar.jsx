      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        {userInfo && userInfo.user ? (
          <div className="flex items-center gap-6">
            ...
            {userInfo.user.role === 'manager' && (
              <div className="hidden md:flex items-center gap-8 text-lg font-semibold">
                <Link to="/manager/dashboard" className="hover:text-primary transition-colors">
                  Dashboard
                </Link>
                <Link to="/manager/showcase" className="hover:text-primary transition-colors">
                  My Showcase
                </Link>
              </div>
            )}
            ...
            <div className="flex items-center gap-4">
              <span className="font-semibold text-base hidden sm:block">
                Welcome, {userInfo.user.name.split(' ')[0]}!
              </span>
          ...
          <div className="flex items-center gap-6">
            <Link
              to="/login"
              className={`flex items-center gap-2 hover:text-primary transition-colors font-semibold ${textColor}`}
            >
              <FaUserCircle />
              <span>Sign In</span>
            </Link>
